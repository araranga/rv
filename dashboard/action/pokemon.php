...
<div class='row'>
          ...
          <div class="col-lg-6 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?php echo $pokemons = mysql_num_rows_md(mysql_query_md("SELECT * FROM tbl_pokemon_users WHERE user='$user'"));; ?> / 15</h3>
...
?>	
		...
		<div class='typedataholder'>
		   ...
		   <input class="btn btn-info btn-lg btnbattle" style='background-color: #ff0000;' type="button" onclick="sellme('<?php echo $rowqpokes['hash']; ?>')" name="sell" value="Sell!">
			<?php } else { 
			?>
			<span style='color:red;'>This pokemon is on market</span>
			<?php
			} ?>
		</div>
<?php
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Queue For Battle - <span class='hashbattlesell'></span></h4>
...
<div class="modal fade" id="modal-primary1" style="display: none;">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Sell This Pokemon - <span class='hashbattle'></span></h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">×</span></button>
            </div>
