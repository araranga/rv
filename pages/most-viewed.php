<div class="gallery">
  ...
  <div class="jg_topview">
    <div class="sectiontableheader"> Top 10 most viewed artwork&nbsp; </div> 
	
<?php
$query = "SELECT a.*,b.name as catname,b.alias as catalias FROM joomgallery as a LEFT JOIN joomgallery_catg as b ON a.catid=b.cid ORDER by a.hits DESC LIMIT 10";
